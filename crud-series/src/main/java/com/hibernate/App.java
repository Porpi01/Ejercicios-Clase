...
public class App {
	...
	private JTable tableTemporadas;
	private JTable tableEpisodios;
	...
	private void initialize() {
		...
		frmCrudSeries.getContentPane().setBackground(UIManager.getColor("Button.select"));
		frmCrudSeries.setTitle("CRUD series");
		frmCrudSeries.setBounds(100, 100, 1423, 528);
		...
		scrollPaneSerie.setBounds(10, 11, 563, 220);
		...
		textFieldID.setBounds(164, 276, 101, 20);
		...
		textFieldSerie.setBounds(164, 320, 170, 20);
		...
		textFieldTemporadas.setBounds(164, 362, 101, 20);
		...
		textFieldCapitulos.setBounds(164, 404, 101, 20);
		...
		btnGuardar.setBounds(10, 455, 123, 23);
		...
		btnBorrar.setBounds(483, 455, 89, 23);
