	...
	private void initialize() {
		...
		chckbxCafé.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				double suma1 = 0, suma2 = 0, suma3 = 0, suma4 = 0, suma5 = 0;
				...
				if (rdbtnTarjeta.isSelected()) {
					...
					if (!mat.matches()) {
						...
						precioFinal = suma1 + suma2 + suma3 + suma4 + suma5;
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (rdbtnTarjeta.isSelected()) {
					...
					if (!mat.matches()) {
						...
						precioFinal = suma1 + suma2 + suma3 + suma4 + suma5;
						textPaneTicket.setText(textPaneTicket.getText() + "\n" + "TOTAL:" + String.format("%.2f",precioFinal));
						textPaneTicket.setText(textPaneTicket.getText() + "\n" + "Le ha atendido Carmen González Navarro");
					}
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (rdbtnTarjeta.isSelected()) {
					...
					if (!mat.matches()) {
						...
						textPaneTicket.setText(textPaneTicket.getText() + "\n" + "Le ha atendido Jorge Castro García");
