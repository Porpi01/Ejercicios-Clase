...
/**
 * Clase CreateJPanel: clase para crear un perfil
...
// declaración de una enumeración donde listamos 3 departamentos 
    ...
    private void initComponents() {
		...
		//Comprobación de si los datos introducidos en el textFieldLocalizacion son correctos
      ...
      //Comprobación de si los datos introducidos en el nombreTextField son correctos
        ...
        //Comprobación de si los datos introducidos en el phoneTextField son correctos
        ...
        //Comprobación de si los datos introducidos en el seguridadSocialTextField son correctos
        ...
        //Switch del comboBox departamento para saber la elección del usuario sobre el departamento
        ...
        JLabel jLabelSueldo = new JLabel();
        			...
        			.addGroup(layout.createParallelGroup(Alignment.LEADING)
        				.addGroup(layout.createSequentialGroup()
        					.addGroup(layout.createParallelGroup(Alignment.LEADING)
        						...
        						.addComponent(jLabelSueldo, GroupLayout.PREFERRED_SIZE, 148, GroupLayout.PREFERRED_SIZE))
        					...
        					.addGroup(layout.createParallelGroup(Alignment.LEADING)
        						...
        						.addComponent(textFieldSueldo, GroupLayout.PREFERRED_SIZE, 244, GroupLayout.PREFERRED_SIZE))
        					.addPreferredGap(ComponentPlacement.RELATED)
        ...
        layout.linkSize(SwingConstants.HORIZONTAL, new Component[] {nombreTextField, fechaIncorporacionTextField, LocalizaciónTextField, phoneTextField, seguridadSocialTextField, emailTextField, bancoTextField, fechaNacimientoTextField, departamentocomboBox});
    ...
    private void createBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_createBtnActionPerformed
        /** Comprobación de si las fechas están bien introducidas y de si los campos están completos o vacíos así como si en el campo aparece la palabra error al darle al botón create
    	*Si todo es correcto se creará el perfil si no irán apareciendo mensajes para avisar al usuario
    	* Finalmente se crea una nueva persona y se añade a la listaPerfiles creada en el MainJFrame*/
		...
		if (fechaNacimiento.equals("")) {
			...
			if (edad.getYears() < 18) {
				JOptionPane.showMessageDialog(null, "El empleado es menor de edad");
						...
						|| fechaIncorporacionTextField.getText().isEmpty() || textFieldSueldo.getText().isEmpty()) {
				...
				JOptionPane.showMessageDialog(null, "Hay datos erróneos");
	    	      ...
	    	      person.setSueldo(textFieldSueldo.getText());
	    	    
	    	      person.setFechaIncorporacion(fechaIncorporacionTextField.getText());
	    	      person.setImageTxt(picTextPath.getText());person.setImageTxt(picTextPath.getText());
	    	     ...
	    	     person = new Person (nombreTextField.getText(), LocalizaciónTextField.getText(),fechaNacimientoTextField.getText(),
	    	    		 phoneTextField.getText(),departamento, emailTextField.getText(),seguridadSocialTextField.getText(),
	    	    		 fechaIncorporacionTextField.getText(),picTextPath.getText(),bancoTextField.getText(), textFieldSueldo.getText());
	    	    
	    	     MainJFrame. listaPerfiles.add(person);
